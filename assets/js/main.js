...
(function () {
  ...
  const MENU_DATA = [
    { title: "Pizza Deals", items: [
      { id: "d3", img: "https://images.unsplash.com/photo-1602658014714-26b99d5a45cf?w=600&q=75&fit=crop&auto=format", name: "Special Deal", desc: "1 Large Ten 11 Special Pizza, 1 Half Special Pasta, 1 Drink 1.5 Ltr", prices: [["", 1950]] },
      { id: "d4", img: "https://images.unsplash.com/photo-1602658014714-26b99d5a45cf?w=600&q=75&fit=crop&auto=format", name: "Value Deal", desc: "2 Medium Pizzas (Ten 11 Special + Reg), 1 Drink 1.5 Ltr", prices: [["", 2050]] },
      { id: "d5", img: "https://images.unsplash.com/photo-1602658014714-26b99d5a45cf?w=600&q=75&fit=crop&auto=format", name: "Super Deal", desc: "1 Large Ten 11 Special Pizza, 1 Medium Reg. Pizza, 1 Drink 1.5 Ltr", prices: [["", 2400]] },
      { id: "d6", img: "https://images.unsplash.com/photo-1602658014714-26b99d5a45cf?w=600&q=75&fit=crop&auto=format", name: "Friends Deal", desc: "4 Burgers (Chicken, BBQ), 6 Pcs Wings Oven Baked, 1 Drink 1.5 Ltr", prices: [["", 1600]] },
      { id: "d7", img: "https://images.unsplash.com/photo-1602658014714-26b99d5a45cf?w=600&q=75&fit=crop&auto=format", name: "Chaska Deal", desc: "1 Small Ten 11 Sp. Pizza, 1 Half Pasta, 6 Pcs Wings Oven Baked, 1 Drink 1 Ltr", prices: [["", 1200]] },
      { id: "d8", img: "https://images.unsplash.com/photo-1602658014714-26b99d5a45cf?w=600&q=75&fit=crop&auto=format", name: "Royal Deal", desc: "1 Large Behari Kabab Pizza, 1 Half Pasta, 2 Patty Burger, 1 Drink 1.5 Ltr", prices: [["", 2400]] },
      ...
      { id: "d10", img: "https://images.unsplash.com/photo-1602658014714-26b99d5a45cf?w=600&q=75&fit=crop&auto=format", name: "Family Deal", desc: "2 XL Ten 11 Special Pizzas, 1 Full Pasta, 4 Pcs Spin Rolls, 10 Pcs Wings Oven Baked, 2 Drinks 1.5 Ltr", prices: [["", 5550]] },
    ]},
    { title: "Fried Deals", items: [
      { id: "d11", img: "https://images.unsplash.com/photo-1611698529138-c5968262a080?w=600&q=75&fit=crop&auto=format", name: "Deal 11", desc: "1 Zinger Burger, 1 Reg. Fries, 1 Reg. Drink", prices: [["", 620]] },
      { id: "d12", img: "https://images.unsplash.com/photo-1611698529138-c5968262a080?w=600&q=75&fit=crop&auto=format", name: "Deal 12", desc: "3 Chicken Pcs, 1 Reg. Fries, Half Ltr Drink", prices: [["", 950]] },
      { id: "d13", img: "https://images.unsplash.com/photo-1611698529138-c5968262a080?w=600&q=75&fit=crop&auto=format", name: "Deal 13", desc: "2 Zinger Burger, 10 Pcs Hot Wings, 1.5 Ltr Drink", prices: [["", 1430]] },
      { id: "d14", img: "https://images.unsplash.com/photo-1611698529138-c5968262a080?w=600&q=75&fit=crop&auto=format", name: "Deal 14", desc: "4 Zinger Burger, 1.5 Ltr Drink", prices: [["", 1500]] },
      { id: "d15", img: "https://images.unsplash.com/photo-1611698529138-c5968262a080?w=600&q=75&fit=crop&auto=format", name: "Deal 15", desc: "2 Chicken Pcs, 2 Zinger Burger, 1.5 Ltr Drink", prices: [["", 1260]] },
      { id: "d16", img: "https://images.unsplash.com/photo-1611698529138-c5968262a080?w=600&q=75&fit=crop&auto=format", name: "Deal 16", desc: "2 Zinger Burger, 2 Patty Burger, 1 Ltr Drink", prices: [["", 1280]] },
      { id: "d17", img: "https://images.unsplash.com/photo-1611698529138-c5968262a080?w=600&q=75&fit=crop&auto=format", name: "Deal 17", desc: "3 Chicken Shawarma, 3 Zinger Burger, 10 Hot Wings, 5 Nuggets, 2.25 Ltr Drink", prices: [["", 2700]] },
      { id: "d18", img: "https://images.unsplash.com/photo-1611698529138-c5968262a080?w=600&q=75&fit=crop&auto=format", name: "Deal 18", desc: "9 Chicken Pcs, 1 Reg. Fries, 1 Ltr Drink", prices: [["", 2200]] },
    ]},
    { title: "Ten 11 Special Flavours (Pizza)", items: [
      { id: "sp1", img: "https://images.unsplash.com/photo-1542282811-943ef1a977c3?w=600&q=75&fit=crop&auto=format", name: "Ten 11 Special Pizza", prices: [["S", 510], ["M", 1050], ["L", 1350], ["XL", 1850]] },
      { id: "sp2", img: "https://images.unsplash.com/photo-1542282811-943ef1a977c3?w=600&q=75&fit=crop&auto=format", name: "Bonfire Pizza", prices: [["S", 510], ["M", 1050], ["L", 1350], ["XL", 1850]] },
      { id: "sp3", img: "https://images.unsplash.com/photo-1542282811-943ef1a977c3?w=600&q=75&fit=crop&auto=format", name: "Behari Kabab Pizza", prices: [["M", 1100], ["L", 1400], ["XL", 2050]] },
      { id: "sp4", img: "https://images.unsplash.com/photo-1542282811-943ef1a977c3?w=600&q=75&fit=crop&auto=format", name: "Kabab Stuffed Pizza", prices: [["M", 1150], ["L", 1500], ["XL", 2100]] },
      { id: "sp5", img: "https://images.unsplash.com/photo-1542282811-943ef1a977c3?w=600&q=75&fit=crop&auto=format", name: "Cheese Stuffed Pizza", prices: [["M", 1150], ["L", 1500], ["XL", 2100]] },
      { id: "sp6", img: "https://images.unsplash.com/photo-1542282811-943ef1a977c3?w=600&q=75&fit=crop&auto=format", name: "Ch. Cheese Stuffed Pizza", prices: [["M", 1150], ["L", 1500], ["XL", 2100]] },
      { id: "sp7", img: "https://images.unsplash.com/photo-1542282811-943ef1a977c3?w=600&q=75&fit=crop&auto=format", name: "Royal Crust Pizza", prices: [["M", 1150], ["L", 1500], ["XL", 2100]] },
      { id: "sp8", img: "https://images.unsplash.com/photo-1542282811-943ef1a977c3?w=600&q=75&fit=crop&auto=format", name: "Malai Boti Pizza", prices: [["M", 1150], ["L", 1500], ["XL", 2100]] },
    ]},
    { title: "Regular Flavours (Pizza)", items: [
      { id: "rg1", img: "https://images.unsplash.com/photo-1542282811-943ef1a977c3?w=600&q=75&fit=crop&auto=format", name: "Chicken Tikka", prices: [["S", 450], ["M", 950], ["L", 1250], ["XL", 1650]] },
      { id: "rg2", img: "https://images.unsplash.com/photo-1542282811-943ef1a977c3?w=600&q=75&fit=crop&auto=format", name: "Chicken Fajita", prices: [["S", 450], ["M", 950], ["L", 1250], ["XL", 1650]] },
      { id: "rg3", img: "https://images.unsplash.com/photo-1542282811-943ef1a977c3?w=600&q=75&fit=crop&auto=format", name: "Cheese Loaded", prices: [["S", 450], ["M", 950], ["L", 1250], ["XL", 1650]] },
      { id: "rg4", img: "https://images.unsplash.com/photo-1542282811-943ef1a977c3?w=600&q=75&fit=crop&auto=format", name: "Chicken Supreme", prices: [["S", 470], ["M", 1000], ["L", 1300], ["XL", 1700]] },
      { id: "rg5", img: "https://images.unsplash.com/photo-1542282811-943ef1a977c3?w=600&q=75&fit=crop&auto=format", name: "Super Supreme", prices: [["S", 490], ["M", 1050], ["L", 1350], ["XL", 1750]] },
    ]},
    { title: "Burgers", items: [
      ...
      { id: "b2", img: "https://images.unsplash.com/photo-1637710847214-f91d99669e18?w=600&q=75&fit=crop&auto=format", name: "Mighty Burger", prices: [["", 550]] },
      ...
      { id: "b4", img: "https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=600&q=75&fit=crop&auto=format", name: "BBQ Burger", prices: [["", 300]] },
      ...
      { id: "b7", img: "https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=600&q=75&fit=crop&auto=format", name: "Grill Burger", prices: [["", 350]] },
    ]},
    ...
    { title: "Shawarma (Rolls)", items: [
      ...
      { id: "sh2", img: "https://images.unsplash.com/photo-1719282431987-2382e77e5a1b?w=600&q=75&fit=crop&auto=format", name: "Ch. Cheese Shawarma", prices: [["", 300]] },
      ...
      { id: "sh4", img: "https://images.unsplash.com/photo-1719282431987-2382e77e5a1b?w=600&q=75&fit=crop&auto=format", name: "Zinger Shawarma", prices: [["", 300]] },
      ...
      { id: "sh6", img: "https://images.unsplash.com/photo-1719282431987-2382e77e5a1b?w=600&q=75&fit=crop&auto=format", name: "Kabab Shawarma", prices: [["", 300]] },
    ...
    { title: "Paratha Rolls", items: [
      { id: "pr1", img: "https://images.unsplash.com/photo-1719282431987-2382e77e5a1b?w=600&q=75&fit=crop&auto=format", name: "Chicken Paratha", prices: [["", 250]] },
      ...
      { id: "pr3", img: "https://images.unsplash.com/photo-1719282431987-2382e77e5a1b?w=600&q=75&fit=crop&auto=format", name: "Zinger Paratha", prices: [["", 300]] },
      ...
      { id: "pr5", img: "https://images.unsplash.com/photo-1719282431987-2382e77e5a1b?w=600&q=75&fit=crop&auto=format", name: "Kabab Paratha", prices: [["", 300]] },
    ...
    { title: "Rolls", items: [
      { id: "rl1", img: "https://images.unsplash.com/photo-1598806243937-2072d39bc11d?w=600&q=75&fit=crop&auto=format", name: "Spin Roll", prices: [["", 500]] },
      ...
      { id: "rl3", img: "https://images.unsplash.com/photo-1598806243937-2072d39bc11d?w=600&q=75&fit=crop&auto=format", name: "Tampeli Roll", prices: [["", 550]] },
      ...
      { id: "rl5", img: "https://images.unsplash.com/photo-1598806243937-2072d39bc11d?w=600&q=75&fit=crop&auto=format", name: "Ten 11 Special Roll", prices: [["", 550]] },
    ]},
    ...
    { title: "Extra Toppings", items: [
      { id: "et1", img: "https://images.unsplash.com/photo-1542282811-943ef1a977c3?w=600&q=75&fit=crop&auto=format", name: "Extra Topping — Chicken", prices: [["S", 100], ["M", 120], ["L", 140], ["XL", 170]] },
      { id: "et2", img: "https://images.unsplash.com/photo-1542282811-943ef1a977c3?w=600&q=75&fit=crop&auto=format", name: "Extra Topping — Cheese", prices: [["S", 100], ["M", 120], ["L", 140], ["XL", 170]] },
    ]},
    { title: "Add-Ons", items: [
